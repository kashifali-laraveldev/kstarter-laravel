<div class="row g-3">
    <div class="col-12">
        ...
        <select class="form-select" name="category" id="add_perm_category">
    ...
    <div class="col-12">
        ...
        <input type="text" class="form-control" name="name" placeholder="e.g. All Users Listing">
    </div>
    <div class="col-12">
    ...
    <div class="col-12">
        <div class="form-check form-switch mt-1">
            <input class="form-check-input" type="checkbox" name="show_in_menu" id="add_perm_show_in_menu">

...
@section('content')
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <img src="{{ asset('admin_assets/img/avatars/' . [1,5,6,7][$loop->index % 4] . '.png') }}"
                                         class="rounded-circle" style="width:32px;height:32px;object-fit:cover;" alt="{{ $user[1] }}">
    ...
    {{-- Single User Drawer (Add & Edit) --}}
    <div class="offcanvas offcanvas-end" tabindex="-1" id="userDrawer" aria-labelledby="userDrawerTitle">
        <div class="offcanvas-header">
            <h5 class="offcanvas-title">
                <i id="userDrawerIcon" class="bx bx-user-plus me-2 text-primary"></i>
                <span id="userDrawerTitle">Add New User</span>
            </h5>
        ...
        <form id="userForm" onsubmit="return false">
            <div class="offcanvas-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="first_name" id="user_first_name" placeholder="John">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Last Name</label>
                        <input type="text" class="form-control" name="last_name" id="user_last_name" placeholder="Doe">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">User Name</label>
                        <input type="text" class="form-control" name="username" id="user_username" placeholder="john.doe">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Email Address</label>
                        <input type="email" class="form-control" name="email" id="user_email" placeholder="john@example.com">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Mobile Number</label>
                        <input type="text" class="form-control" name="mobile" id="user_mobile" placeholder="+1 202 555 0111">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Department</label>
                        <input type="text" class="form-control" name="department" id="user_department" placeholder="e.g. Engineering">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="password" class="form-control" name="password_confirmation" id="user_password_confirmation" placeholder="············">
                    </div>
                </div>
            </div>
            <div class="offcanvas-footer d-flex gap-2">
                <button type="submit" class="btn btn-primary">
                    ...
                    <span id="userDrawerSaveLabel">Save User</span>
                </button>

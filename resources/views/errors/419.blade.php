...
<head>
    ...
    <title>419 - Session Expired | KStarter Laravel</title>
    ...
    <style>
        ...
        .ks-error-divider {
            ...
            height: 3px;
            border-radius: 4px;
            background: linear-gradient(90deg, #ffab00, #ffd166);
...
<div class="ks-error-wrapper">
    ...
    <div class="ks-error-code">419</div>

    <div class="ks-error-divider"></div>

    <h4 class="ks-error-title">Session Expired</h4>
    ...
    <div class="ks-error-actions">
        ...
        <a href="{{ url('admin/login') }}" class="btn btn-warning" style="color:#fff;">
            <i class="bx bx-log-in me-1"></i> Login Again
        </a>
    </div>
